...
Esse método é o mais primitivo que não utiliza comparações para executar a ordenação. Para ordenar um vetor ele armazena chaves com os valores de cada item do vetor e sua posição, assim consegue realocar os itens em ordem depois de ter salvo o valor e a posição de todo o vetor.
...
Faz a ordenação de um método parecido do couting, contudo analisa os valores do vetor por uma base, isto é, pode analisar por potências de 10 $(10^{0}, 10^1, 10^2)$ e ordena através dessas base, de forma que ao finalizar todas bases para representar o número de maior valor todo o vetor estará ordenado.
